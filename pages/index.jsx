  ...
  return (
    ...
    <section className="w-screen h-max py-[70px] bg-white px-[40px] flex flex-col items-center justify-center relative z-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 w-full max-w-5xl items-center justify-items-center">
        <img src="/clients/client1.png" alt="Client 1" className="h-20 object-contain grayscale hover:grayscale-0 transition duration-300" />
        ...
        <img src="/clients/client3.png" alt="Client 3" className="h-20 object-contain grayscale hover:grayscale-0 transition duration-300" />
        <img src="/clients/client4.png" alt="Client 4" className="h-20 object-contain grayscale hover:grayscale-0 transition duration-300" />
